            ...
            mDatabase.child(auth.getCurrentUser().getUid()).setValue(new MentorDetailsModel(skill, qualification, experience, mentorTypeString), new DatabaseReference.CompletionListener() {
                ...
                public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                    if (databaseError != null) {
                        ...
                        auth.getCurrentUser().sendEmailVerification().addOnCompleteListener(MentorDetailsInsertActivity.this, new OnCompleteListener<Void>() {
                            @Override
                            public void onComplete(@NonNull Task<Void> task) {
                                Toast.makeText(MentorDetailsInsertActivity.this, "Please verify your email ! check your email", Toast.LENGTH_SHORT).show();
                            }
                        });
